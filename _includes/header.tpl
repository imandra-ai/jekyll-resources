                        ...
                        <ul class="top-nav-bar__links top-nav-bar__links--hidden-smaller-than-tablet">
                            ...
                            <li class="top-nav-bar__item top-nav-bar__item--group dropdown--engine">
                                ...
                                <ul class="dropdown-content dropdown-content--engine">
                                    <li class="dropdown__item dropdown__item--with-icon">
                                        <img class="dropdown__icon" src="{{ site.baseurl }}{% link jekyll-resources/assets/img/icon--docs--menu.svg %}" alt="Button Icon" title="">
                                        <a class="dropdown__link" href="https://docs.imandra.ai/">Docs</a></li>
                                    <li class="dropdown__item dropdown__item--with-icon">
                                        <img class="dropdown__icon" src="{{ site.baseurl }}{% link jekyll-resources/assets/img/icon--research--menu.svg %}" alt="Button Icon" title="">
                                        <a class="dropdown__link" href="https://www.imandra.ai/research">Research</a></li>
                                    <li class="dropdown__item dropdown__item--with-icon">
                                        <img class="dropdown__icon" src="{{ site.baseurl }}{% link jekyll-resources/assets/img/icon--core--menu.svg %}" alt="Button Icon" title="">
                            ...
                            <li class="top-nav-bar__item top-nav-bar__item--group dropdown--media">
                                ...
                                <ul class="dropdown-content dropdown-content--media">
                                    <li class="dropdown__item dropdown__item--with-icon">
                                        <img class="dropdown__icon" src="{{ site.baseurl }}{% link jekyll-resources/assets/img/icon--media--menu.svg %}" alt="Button Icon" title="">
                                        <a class="dropdown__link " href="https://www.imandra.ai/media">Media</a></li>
                                    <li class="dropdown__item dropdown__item--with-icon">
                                        <img class="dropdown__icon" src="{{ site.baseurl }}{% link jekyll-resources/assets/img/icon--blog--menu.svg %}" alt="Button Icon" title="">
                            ...
                            <li class="top-nav-bar__item top-nav-bar__item--group dropdown--company">
                                ...
                                <ul class="dropdown-content dropdown-content--company">
                                    <li class="dropdown__item dropdown__item--with-icon">
                                        <img class="dropdown__icon" src="{{ site.baseurl }}{% link jekyll-resources/assets/img/icon--about--menu.svg %}" alt="Button Icon" title="">
                                        <a class="dropdown__link" href="https://www.imandra.ai/about">About</a></li>
                                    <li class="dropdown__item dropdown__item--with-icon">
                                        <img class="dropdown__icon" src="{{ site.baseurl }}{% link jekyll-resources/assets/img/icon--careers--menu.svg %}" alt="Button Icon" title="">

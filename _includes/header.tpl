                        ...
                        <ul class="top-nav-bar__links top-nav-bar__links--hidden-smaller-than-tablet">
                            ...
                            <li class="top-nav-bar__item top-nav-bar__item--group dropdown--applications">
                                ...
                                <ul class="dropdown-content dropdown-content--applications">
                                    <li class="dropdown__item dropdown__item--with-icon">
                                        <img class="dropdown__icon" src="{{ repo_dir }}/jekyll-resources/assets/img/icon--menu--fv.svg" alt="Formal Verification" title="Formal Verification Icon">
                                        <a class="dropdown__link" href="https://www.imandra.ai/app-fv">Formal Verification</a>
                                    </li>
                                    <li class="dropdown__item dropdown__item--with-icon">
                                        <img class="dropdown__icon" src="{{ repo_dir }}/jekyll-resources/assets/img/icon--menu--mbse.svg" alt="Model-Based Software Engineering" title="Model-Based Software Engineering Icon">
                                        <a class="dropdown__link" href="https://www.imandra.ai/app-mbse">Model-Based Software Engineering</a>
                                    </li>
                                    <li class="dropdown__item dropdown__item--with-icon">
                                        <img class="dropdown__icon" src="{{ repo_dir }}/jekyll-resources/assets/img/icon--menu--si.svg" alt="IPL Demo Gallery" title="System Integration Icon">
                            ...
                            <li class="top-nav-bar__item top-nav-bar__item--group dropdown--products">
                                ...
                                <ul class="dropdown-content dropdown-content--products">
                                    ...
                                    <li class="dropdown__item dropdown__item--with-icon">
                                        <img class="dropdown__icon" src="/{{ repo_dir }}/jekyll-resources/assets/img/icon--menu--ipl.svg" alt="Imandra Protocol Language" title="Imandra Protocol Language Icon">
                                    ...
                                    <li class="dropdown__item dropdown__item--with-icon">
                                        <img class="dropdown__icon" src="{{ repo_dir }}/jekyll-resources/assets/img/icon--menu--autopilot.svg" alt="Imandra Markets - Autopilot" title="Imandra Markets - Autopilot Icon">
